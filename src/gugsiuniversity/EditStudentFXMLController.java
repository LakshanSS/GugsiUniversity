...
public class EditStudentFXMLController implements Initializable {
    ...
    @FXML
    private TextField txtmarks531;
    @FXML
    private TextField txtmarks535;
    @FXML
    private TextField txtmarks537;
    @FXML
    private TextField txtmarks538;
    @FXML
    private TextField txtmarks539;
    @FXML
    private TextField txtmarks546;
    @FXML
    private TextField txtmarks554;
    @FXML
    private TextField txtmarks555;

    @FXML
    private RadioButton rbtnseminar;

    @FXML
    private ComboBox cmbboxop1;
    @FXML
    private ComboBox cmbboxop2;
    @FXML
    private ComboBox cmbboxop3;
    @FXML
    private ComboBox cmbboxop4;
    @FXML
    private ComboBox cmbboxop5;
    @FXML
    private ComboBox cmbboxop6;
    @FXML
    private ComboBox cmbboxop7;

    @FXML
    private TextField txtop1marks;
    @FXML
    private TextField txtop2marks;
    @FXML
    private TextField txtop3marks;
    @FXML
    private TextField txtop4marks;
    @FXML
    private TextField txtop5marks;
    @FXML
    private TextField txtop6marks;
    @FXML
    private TextField txtop7marks;

    @FXML
    private ComboBox cmbboxproject;
    @FXML
    private RadioButton rbtnproject;

    @FXML
    private Button btnSave;
    @FXML
    private TextField txtinputstid;
    @FXML
    ...
    private void searchClicked(ActionEvent evt) {
        ...
        if (studentfound == false) {
            ...
            cmbboxproject.setValue(modulearr.get(i).getProjectType());
