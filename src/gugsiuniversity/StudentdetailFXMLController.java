...
public class StudentdetailFXMLController implements Initializable {
    ...
    @FXML
    private Label lblcore1marks;
    @FXML
    private Label lblcore2marks;
    @FXML
    private Label lblcore3marks;
    @FXML
    private Label lblcore4marks;
    @FXML
    private Label lblcore5marks;
    @FXML
    private Label lblcore6marks;
    @FXML
    private Label lblcore7marks;
    @FXML
    private Label lblcore8marks;
    ...
    @FXML
    private Label lblopt1marks;
    @FXML
    private Label lblopt2marks;
    @FXML
    private Label lblopt3marks;
    @FXML
    private Label lblopt4marks;
    @FXML
    private Label lblopt5marks;
    @FXML
    private Label lblopt6marks;
    @FXML
    private Label lblopt7marks;
    @FXML
    private Label lblseminar;
    @FXML
    private Label lblprojectType;
    @FXML
    private Label lblprojectResult;
    @FXML
    private Label lblGPA;
    @FXML
    private Label lblDegreeName;
    @FXML
    private Label lblDegreeClass;
    private int i;
